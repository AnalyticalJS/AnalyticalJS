...
"use strict";
__webpack_require__.r(__webpack_exports__);
Object(function webpackMissingModule() { var e = new Error("Cannot find module 'chartjs-chart-geo/build'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());

fetch('https://unpkg.com/world-atlas/countries-50m.json').then(function (r) {
  return r.json();
}).then(function (data) {
  var countries = Object(function webpackMissingModule() { var e = new Error("Cannot find module 'chartjs-chart-geo/build'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(data, data.objects.countries).features;
